...
def is_cybox(entity):
    """Returns true if `entity` is an instance of :class:`cybox.entities.Entity,`."""
    return isinstance(entity, cybox.entities.Entity,)


def is_entity(entity):
    """Returns true if `entity` is an instance of :class:`.Entity` or
    :class:`cybox.entities.Entity,`.

    """
    return isinstance(entity, (cybox.entities.Entity, stix.Entity))


def is_entitylist(entity):
    """Returns true if `entity` is an instance of :class:`.EntityList`
    or :class:`cybox.entities.Entity,List`.

    """
    return isinstance(entity, (cybox.entities.EntityList, stix.EntityList))
...
def iter_vars(obj):
    ...
    instance_vars = iter(list(obj.__dict__.items()))
